...
old_header = """<div id="gallery">
  <section class="hero" style="padding-top:56px;">
    <div class="wrap">
      ...
      <p class="lead">Take a look at some of the control panels, PLC racks, and automation setups we've designed and built recently.</p>
    </div>
  </section>
...
new_header = """<section id="gallery" style="background:#ffffff; border-top:1px solid var(--line); border-bottom:1px solid var(--line); padding: 80px 0;">
  <div class="wrap">
    <div style="text-align: center; max-width: 700px; margin: 0 auto 64px;">
      ...
      <p class="lead" style="color:var(--text-dim); margin-top:16px;">Take a look at some of the control panels, PLC racks, and automation setups we've designed and built recently.</p>
    </div>"""

# Replace the beginning of the gallery section
